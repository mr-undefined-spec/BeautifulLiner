...
class LinearApproximateCurve(Curve):
    ...
    def broaden(self, broaden_width, position):
        ...
        tmp_going_ctrl_p_set = self.__get_slightly_away_control_point_set(self._going_ctrl_p_set, broaden_width, True, position)
        tmp_returning_ctrl_p_set = self.__get_slightly_away_control_point_set(self._going_ctrl_p_set, broaden_width, False, position)
