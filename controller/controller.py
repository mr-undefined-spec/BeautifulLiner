...
class Controller:
    def run(self, mode, reading_file_path, linear_approximate_length, delete_ratio, broad_width, output_color, progress_bar=None, log_text=None):
        ...
        smoothened.set_write_options(is_fill=True, color=output_color)
